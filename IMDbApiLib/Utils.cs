...
namespace IMDbApiLib
{
    public abstract class Utils
    {
        ...
        public static async Task<string> DownloadJsonAsync(string url, HttpClient clientA)
        {
            try
            {
                string json = string.Empty;
                var request = await clientA.GetAsync(url);
                json = request.Content.ToString();
        ...
        public static async Task<T> DownloadObjectAsync<T>(string url, HttpClient clientB)
        {
            try
            {
                return await clientB.GetFromJsonAsync<T>(url);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static Task DownloadFileAsync(string filePath, string url, HttpClient clientC)
        {
            throw new NotImplementedException("Not ported for Blazor.");
            // try
            // {
            //     await clientC.DownloadFileTaskAsync(url, filePath);
            // }
            // catch
            // { }
        }

        public static Task DownloadImageAsync(string filePath, string url, HttpClient clientD)
        {
            throw new NotImplementedException("Not ported for Blazor.");
            // try
            // {
            ...
            //         {
            //             await clientD.DownloadFileTaskAsync(url, filePath);
            //         }
            //         else // Check equal
            //         {
        ...
        public static async Task<string> GetUrlFilenameAsync(string url, HttpClient clientE)
        {
            try
            {
                string result = "";
        ...
        public static Task<byte[]> DownloadDataAsync(string url, HttpClient clientF, ProgressData progress = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException("Not ported for Blazor.");
            // try
            // {
